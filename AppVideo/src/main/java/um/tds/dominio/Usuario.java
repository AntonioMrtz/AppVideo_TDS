...
public class Usuario {
	...
	public Usuario(String nombre, String apellidos, String email, boolean premium, String user, String contraseña,
			LocalDate fecha) { // se crean los usuarios como no premium , cambiar si necesario
	...
	public boolean addLista(String nombre, List<Video> videos) {
		...
		if (actualizarListaVideos(nombre, videos))
			return false; // se ha actualizado , no hace falta crear otra
