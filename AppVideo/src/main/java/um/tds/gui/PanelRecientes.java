...
public class PanelRecientes extends JPanel implements IWindow {
	...
	public void enter() {
		...
		if (Controlador.getUnicaInstancia().getUsuarioActual().isPremium() && comboBox.getItemCount() == 2)
	...
	private ActionListener listenerButtons = new ActionListener() {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			lblNewLabel_2 = new JLabel("Reproducciones " + Integer
					.toString(Controlador.getUnicaInstancia().findVideo(arg0.getActionCommand()).getNumRepro()));
